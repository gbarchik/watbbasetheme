...
function grd_scripts() {
	...
	if( !is_admin() ) {
		...
		wp_enqueue_script( 'plugins', get_template_directory() . '/assets/scripts/plugins.min.js', array('jquery'), NULL, true );
		wp_enqueue_script( 'scripts', get_template_directory() . '/assets/scripts/main.min.js', array('jquery'), NULL, true );
	}
}